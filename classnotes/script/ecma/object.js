...
console.log(hostnameC); // {desktop: 2, lab: 1}
console.log(string); // '{"desktop":2,"lab":1}'

const hostString = '{"desktop":2,"lab":1}';

console.log(JSON.parse(hostString)); // {desktop: 2, lab: 1}
...
console.log(hosts.map((host) => host.address)); // ['192.168.0.30', '192.168.0.60']
